...
btn_f16.grid(row=0,column=0,sticky=N+E+W+S,padx=3,pady=3) # ,sticky=N+E+W+S 는 사방으로 펼친다고 생각
...
btn_multiply = Button(root, text="*",width=5,height = 2)


btn_clear.grid(row=1,column=0,sticky=N+E+W+S,padx=3,pady=3)
btn_equal.grid(row=1,column=1,sticky=N+E+W+S,padx=3,pady=3)
btn_div.grid(row=1,column=2,sticky=N+E+W+S,padx=3,pady=3)
btn_multiply.grid(row=1,column=3,sticky=N+E+W+S,padx=3,pady=3)
